...
const Footer1 = () => {
  return (
    <Box mx="3%" p="1" fontSize='16px' fontFamily='"Clear Sans", "Helvetica Neue"' >
      <Box py="2">
      ...
      <Box py="2">
        <Text as="b" fontSize='18px'>We Bring Care to Health.</Text>
      </Box>
      <Box py="2">
      ...
      <Box py="2">
        <Text as="b" fontSize='18px'>Tata 1mg: Your Favourite Online Pharmacy!</Text>
      </Box>
      <Box py="2">
        <Text textAlign="justify">
      ...
      <Box py="2">
        <Text as="b" fontSize='18px'>The Feathers in Our Cap</Text>
      </Box>
      <Box py="2">
        <Text textAlign="justify">
          ...
          <Text as="b" color='#666666' fontSize='18px' >
            BML Munjal Award for 'Business Excellence through Learning and
            Development', Best Online Pharmacy in India Award
          </Text>{" "}
          and{" "}
          <Text as="b" color='#666666' fontSize='18px'> Top 50 venture in The Smart CEO-Startup50 India.</Text>{" "}
          ...
          <Text as="b" color='#666666' fontSize='18px'>BMW Simply Unstoppable Award.</Text>
        </Text>
      </Box>

      <Box py="2">
        <Text as="b" fontSize='18px'>The Services We Offer</Text>
      </Box>
