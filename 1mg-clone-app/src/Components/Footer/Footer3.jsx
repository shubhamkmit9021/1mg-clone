...
const Footer3 = () => {
  return (
    <Box bg="#fffcf8" h="100rem" borderY="1px solid #bfbfbf" pt="9" mb="50px">
      <Box w="90%" m="auto">
        <Grid templateColumns="17% 17% 13% 25% 18%" gap="8">
          <GridItem w="100%">
            <Box>
              <Box my='4'><Text as='b' fontsize='16px' color='#1A1A1A' >Know Us</Text></Box>
              <Box fontSize='14px' color='#666666' >
                <Box>About Us</Box>
                <Box>Contact Us</Box>
                <Box>Press Coverage</Box>
                <Box>Careers</Box>
                <Box>Business Partnership</Box>
                <Box>Become a Health Partner</Box>
                <Box>Corporate Governance</Box>
              </Box>
            </Box>
          </GridItem>
          ...
          <GridItem w="100%">
            <Box>
              <Box my='4'><Text as='b' fontsize='16px' color='#1A1A1A' >Our Policies</Text></Box>
              <Box fontSize='14px' color='#666666' >
                <Box>Privacy Policy</Box>
                <Box>Terms and Conditions</Box>
                <Box>Editorial Policy</Box>
                <Box>Return Policy</Box>
                <Box>IP Policy</Box>
                <Box>Grievance Redressal Policy</Box>
              </Box>
            </Box>
          </GridItem>
          ...
          <GridItem w="100%">
            <Box>
              <Box my='4'><Text as='b' fontsize='16px' color='#1A1A1A' >Our Services</Text></Box>
              <Box fontSize='14px' color='#666666' >
                <Box>Order Medicines</Box>
                <Box>Book Lab Tests</Box>
                <Box>Consult a Doctor</Box>
                <Box>Ayurveda Articles</Box>
                <Box>Hindi Articles</Box>
                <Box>Care Plan</Box>
              </Box>
            </Box>
          </GridItem>
          ...
          <GridItem w="100%">
            <Box>
              <Box my='4'><Text as='b' fontsize='16px' color='#1A1A1A' >Connect</Text></Box>
              <Box fontSize='14px' color='#666666' >
          ...
          <GridItem w="100%">
            <Box>
              <Box my='4' ><Text as='b' fontSize='16px' color='#000000' >Download App</Text></Box>
              <Box w='136px' my='2'>
                <Image
                  _hover={{ cursor: "pointer" }}
